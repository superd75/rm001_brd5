...
<body>
	...
	<style>
		* {	margin:0; padding:0;	}
		...
		.career_tab 											{	position:relative; width:900px; /*border-style:solid; border-color:rgb(0, 0, 0); border-width:0px 0px 1px 0px;*/  }
		.career_tab:after									{ content:""; position:absolute; left:0; bottom:0px; z-index:-1; width:100%; height:1px; background:#000;  }
		.career_tab ul 										{	margin: 0px; padding: 0px; width:900px; display:inline-block; }
		.career_tab li 										{	display:block; float:left; padding:10px 0 10px 0; text-align:center; margin:0px; }
		.career_tab li.ca_tab_on 					{	width: 150px; font-size:14px; border-style:solid; border-color:rgb(0, 0, 0); border-width:1px 1px 0 1px; border-bottom-style:solid; border-bottom-color:#fff; border-bottom-width:1px; background:#fff;  }
		.career_tab li.ca_tab_off 			 	{	width: 150px; font-size:14px;	border-style:solid; border-color:rgb(212, 212, 212); border-width:1px 1px 0px 1px; cursor: pointer; color:#8C8C8C; 	}
	...
	<div id="profile_txt_area">
		<div class="career_tab">
			<ul>
				<li id="caTab1" class="ca_tab_on" 	onclick="caTabclick(1);">1受賞内訳</li> <li id="caTab2" class="ca_tab_off"	onclick="caTabclick(2);">2経歴事項</li>
				<li id="caTab3" class="ca_tab_off"	onclick="caTabclick(3);">3経歴事項</li>
			</ul>
		</div>
